                            ...
                            Repeater {
                                ...
                                delegate: Image {
                                        ...
                                        onClicked: mouse => {
                                            if (mouse.button === Qt.LeftButton) {
                                                ...
                                                if (modelData.menu) { 
                                                    ...
                                                    fallbackTrayMenu.x = mouse.x;
                                                    fallbackTrayMenu.y = trayIcon.height + barWindow.s(4);
                                                    fallbackTrayMenu.open();
                                                }
                                            }
                                        }
                                    }
                                    ...
                                    Popup {
                                        id: fallbackTrayMenu
                                        x: 0
                                        y: trayIcon.height + barWindow.s(4)
                                        width: barWindow.s(80)
                                        height: barWindow.s(32)
                                        padding: 0
                                        ...
                                        background: Rectangle {
                                            ...
                                            border.color: Qt.rgba(mocha.surface1.r, mocha.surface1.g, mocha.surface1.b, 0.8)
                                            border.width: 1
                                        }
                                        ...
                                        MouseArea {
                                            ...
                                            onClicked: {
                                                trayKillProcess.command = ["pkill", "-f", modelData.id];
                                                trayKillProcess.running = true;
                                                fallbackTrayMenu.close();
                                            }

                                            Rectangle {
                                                anchors.fill: parent
                                                radius: barWindow.s(8)
                                                color: parent.containsMouse ? Qt.rgba(mocha.red.r, mocha.red.g, mocha.red.b, 0.1) : "transparent"
                                            }
                                        }
                                    }
                                }
