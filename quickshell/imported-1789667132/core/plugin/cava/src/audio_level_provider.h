...
class AudioLevelProvider : public QObject {
    ...
    Q_PROPERTY(
        QString sourceNodeName READ sourceNodeName WRITE setSourceNodeName NOTIFY sourceNodeNameChanged)
    Q_PROPERTY(bool captureSink READ captureSink WRITE setCaptureSink NOTIFY captureSinkChanged)
    ...
    Q_PROPERTY(double normalizedAmplitude READ normalizedAmplitude NOTIFY valuesChanged)
    Q_PROPERTY(qint64 visualTimestampMs READ visualTimestampMs NOTIFY visualSampleChanged)
    Q_PROPERTY(double visualAmplitude READ visualAmplitude NOTIFY visualSampleChanged)
