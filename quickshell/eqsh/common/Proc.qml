/*
src: https://github.com/AvengeMedia/DankMaterialShell/blob/master/quickshell/Common/Proc.qml
        ...
        function maybeComplete() {
            ...
            if (entry && entry.callback && typeof entry.callback === "function") {
                try {
                    ...
                    Logger.w("Proc::runCommand", "callback error for command: " + entry.command + " Error: " + e);
                }
            }
            try {
                proc.destroy();
