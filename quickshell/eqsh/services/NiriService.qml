/*
src: https://github.com/AvengeMedia/DankMaterialShell/blob/master/quickshell/Services/NiriService.qml
...
Singleton {
    ...
    property var activeToplevel: root.windows.find(w => w.is_focused) || null
